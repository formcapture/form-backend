// Events that can be received by the custom JSONEditor editors
export const RECEIVE_EVENTS = {
  ...
  /**
   * Triggered when the modification of a location has stopped.
   */
...
// Events that will be sent by the custom JSONEditor editors
